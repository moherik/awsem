...
var initPassport = function () {
    ...
    passport_1.default.use(new passport_google_oauth20_1.Strategy({
        ...
        var userRepo, user, newUser, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    userRepo = typeorm_1.getRepository(User_1.User);
                ...
                case 1:
                    ...
                    newUser.email = "muherik.maulana@gmail.com";
                    _a.label = 2;
                case 2:
                    _a.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, userRepo
                            .save(newUser)
                            .then(function (newUser) { return done(undefined, newUser); })];
                case 3:
                    _a.sent();
                    return [3 /*break*/, 5];
                case 4:
                    err_1 = _a.sent();
                    return [2 /*return*/, done(err_1, null)];
