...
var UserController = /** @class */ (function () {
    ...
    UserController.newUser = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        var _a, username, password, name, user, errors, userRepo, err_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _a = req.body, username = _a.username, password = _a.password, name = _a.name;
                ...
                case 5:
                    err_1 = _b.sent();
                    return [2 /*return*/, res.status(409).json(err_1)];
                case 6:
